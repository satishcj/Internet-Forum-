...
class USER extends dbconfig {
   ...
   public static function addNewUser($userData) {
     try {
       ...
       $data = $check;
       } else {//INSERT INTO `users`(`u_id`, `u_name`, `dob`, `gender`, `ed_quali`, `profession`, `con_num`, `email`, `password`) VALUES (1,$name,dob,female,ed_quali,profession,con_num,email,password)";
       $query = "INSERT INTO users (u_id, u_name, password) VALUES ('"name"', '"username"', '"md5(password)"')";
